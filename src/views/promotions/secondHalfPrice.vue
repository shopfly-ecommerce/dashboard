<template>
  <div>
    <el-tabs v-model="activeName" @tab-click="handleToggleClick">
      <el-tab-pane label="The second half price list" name="seconedHalfList">
        <en-table-layout
          toolbar
          pagination
          :tableData="tableData"
          ...
          <div slot="toolbar" class="inner-toolbar">
            <div class="toolbar-btns">
              <el-button type="primary" @click="handleAddSeconedHalf">new</el-button>
            </div>
        ...
        <div class="content-goods-publish">
          <el-form
            ...
            <div class="base-info-item">
              ...
              <div>
                <el-form-item label="Preferential way：">
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        /** New active panel title*/
        secondHalfPriceName: 'Add the second half price activity',
    ...
    methods: {
      ...
      activityType(row, column, cellValue) {
        return 'The second one is half price'
      },
      ...
      handleToggleClick(tab, event) {
        ...
        if (this.activeName === 'seconedHalfList') {
          ...
          this.secondHalfPriceName = 'Add the second half price activity'
      ...
      handleEditMould(row) {
        this.activeName = 'add'
        this.secondHalfPriceName = 'Edit the second half price campaign'
      ...
      /** Inquire information about a second half-price event*/
